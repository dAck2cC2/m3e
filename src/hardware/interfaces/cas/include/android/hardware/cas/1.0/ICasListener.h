...
struct ICasListener : public ::android::hidl::base::V1_0::IBase {
    ...
    static ::android::hardware::Return<::android::sp<ICasListener>> castFrom(const ::android::sp<ICasListener>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<ICasListener>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<ICasListener>&);
