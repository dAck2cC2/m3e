...
struct BpHwDescramblerBase : public ::android::hardware::BpInterface<IDescramblerBase>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<Status>  _hidl_setMediaCasSession(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& sessionId);
    ...
    // Methods from IDescramblerBase follow.
    ::android::hardware::Return<Status> setMediaCasSession(const ::android::hardware::hidl_vec<uint8_t>& sessionId) override;
