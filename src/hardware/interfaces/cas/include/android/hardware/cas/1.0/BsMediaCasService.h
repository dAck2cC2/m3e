...
struct BsMediaCasService : IMediaCasService, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> enumeratePlugins(enumeratePlugins_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
    ...
    ::android::hardware::Return<bool> isSystemIdSupported(int32_t CA_system_id) {
    ...
    ::android::hardware::Return<::android::sp<ICas>> createPlugin(int32_t CA_system_id, const ::android::sp<ICasListener>& listener) {
        ...
        ::android::sp<ICasListener> _hidl_wrapped_listener;
        if (listener != nullptr && !listener->isRemote()) {
            _hidl_wrapped_listener = ICasListener::castFrom(::android::hardware::details::wrapPassthrough<ICasListener>(listener));
        ...
        #ifdef __ANDROID_DEBUGGABLE__
        ::android::sp<ICas> _hidl_out_cas = _hidl_return;
        #endif // __ANDROID_DEBUGGABLE__
        atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
    ...
    ::android::hardware::Return<bool> isDescramblerSupported(int32_t CA_system_id) {
    ...
    ::android::hardware::Return<::android::sp<IDescramblerBase>> createDescrambler(int32_t CA_system_id) {
        ...
        #ifdef __ANDROID_DEBUGGABLE__
        ::android::sp<IDescramblerBase> _hidl_out_descrambler = _hidl_return;
        #endif // __ANDROID_DEBUGGABLE__
        atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
    ...
    ::android::hardware::Return<void> interfaceChain(interfaceChain_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "interfaceChain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->interfaceChain([&](const auto &_hidl_out_descriptors) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                _hidl_args.push_back((void *)&_hidl_out_descriptors);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "interfaceChain", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> debug(const ::android::hardware::hidl_handle& fd, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& options) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "debug", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "debug", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> interfaceDescriptor(interfaceDescriptor_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "interfaceDescriptor", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->interfaceDescriptor([&](const auto &_hidl_out_descriptor) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "interfaceDescriptor", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getHashChain(getHashChain_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "getHashChain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getHashChain([&](const auto &_hidl_out_hashchain) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "getHashChain", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> linkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient, uint64_t cookie) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "linkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "linkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> ping() {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "ping", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "ping", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getDebugInfo(getDebugInfo_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "getDebugInfo", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getDebugInfo([&](const auto &_hidl_out_info) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "getDebugInfo", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> notifySyspropsChanged() {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "notifySyspropsChanged", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        , mEnableInstrumentation = this->mEnableInstrumentation, mInstrumentationCallbacks = this->mInstrumentationCallbacks
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "notifySyspropsChanged", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> unlinkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&recipient);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.cas", "1.0", "IMediaCasService", "unlinkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.cas", "1.0", "IMediaCasService", "unlinkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
