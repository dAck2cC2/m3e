...
struct BsDescrambler : IDescrambler, ::android::hardware::details::HidlInstrumentor {
    ...
    // Methods from IDescrambler follow.
    ::android::hardware::Return<void> descramble(ScramblingControl scramblingControl, const ::android::hardware::hidl_vec<SubSample>& subSamples, const SharedBuffer& srcBuffer, uint64_t srcOffset, const DestinationBuffer& dstBuffer, uint64_t dstOffset, descramble_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
