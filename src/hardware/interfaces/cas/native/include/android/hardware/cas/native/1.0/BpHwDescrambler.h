...
struct BpHwDescrambler : public ::android::hardware::BpInterface<IDescrambler>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_descramble(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ScramblingControl scramblingControl, const ::android::hardware::hidl_vec<SubSample>& subSamples, const SharedBuffer& srcBuffer, uint64_t srcOffset, const DestinationBuffer& dstBuffer, uint64_t dstOffset, descramble_cb _hidl_cb);
    ...
    // Methods from IDescrambler follow.
    ::android::hardware::Return<void> descramble(ScramblingControl scramblingControl, const ::android::hardware::hidl_vec<SubSample>& subSamples, const SharedBuffer& srcBuffer, uint64_t srcOffset, const DestinationBuffer& dstBuffer, uint64_t dstOffset, descramble_cb _hidl_cb) override;
