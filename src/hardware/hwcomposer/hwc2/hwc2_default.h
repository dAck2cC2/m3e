...
struct ComposerClientDefault : public IComposerClient {
    ...
    virtual ::android::hardware::Return<void> setHALInstrumentation() override { /* EMPTY */ return ::android::hardware::Void(); };

    virtual ::android::hardware::Return<bool> linkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient, uint64_t cookie) override { /* EMPTY */ return false; };

    virtual ::android::hardware::Return<void> ping() override { /* EMPTY */ return ::android::hardware::Void(); };
    
    virtual ::android::hardware::Return<void> getDebugInfo(getDebugInfo_cb _hidl_cb) override { /* EMPTY */ return ::android::hardware::Void(); };

    virtual ::android::hardware::Return<void> notifySyspropsChanged() override { /* EMPTY */ return ::android::hardware::Void(); };

    virtual ::android::hardware::Return<bool> unlinkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient) override { /* EMPTY */ return false; };
...
struct ComposerDefault : public IComposer {
    ...
    virtual ::android::hardware::Return<void> createClient(createClient_cb _hidl_cb) override { _hidl_cb(Error::NONE, new ComposerClientDefault()); return ::android::hardware::Void(); };
