...
int NativeWindow::getX() const
{
    return mX;
}

int NativeWindow::getY() const
{
    return mY;
}
...
bool NativeWindow::takeScreenshot(uint8_t *pixelData)
{
    return false;
}

bool NativeWindow::popEvent(Event *event)
{
...
void NativeWindow::pushEvent(Event event)
{
    switch (event.Type)
    {
        case Event::EVENT_MOVED:
...
bool NativeWindow::didTestEventFire()
{
    Event topEvent;
