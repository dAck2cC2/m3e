...
MSVC_EXPORT int sem_init(sem_t *sem, int pshared, unsigned int value);
MSVC_EXPORT int sem_wait(sem_t *sem);
MSVC_EXPORT int sem_trywait(sem_t *sem);
MSVC_EXPORT int sem_timedwait(sem_t *sem, const struct timespec *abs_timeout);
MSVC_EXPORT int sem_post(sem_t *sem);
MSVC_EXPORT int sem_getvalue(sem_t *sem, int *value);
MSVC_EXPORT int sem_destroy(sem_t *sem);
MSVC_EXPORT sem_t *sem_open(const char *name, int oflag, mode_t mode, unsigned int value);
MSVC_EXPORT int sem_close(sem_t *sem);
MSVC_EXPORT int sem_unlink(const char *name);
