...
LI_API extern const ClassTable *objectIDtoClass(SLuint32 objectID); // M3E:
LI_API extern const struct SLInterfaceID_ SL_IID_array[MPH_MAX]; // M3E:
...
#if defined(__GNUC__) || defined(_MSC_VER) // M3E:
