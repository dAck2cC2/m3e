...
#if ENABLE_MEMUNREACHABLE // M3E:
#include <memunreachable/memunreachable.h>
#endif // ENABLE_MEMUNREACHABLE
                                          ...
                                          status_t *status)
{
	...
	mAudioTracks.push_back(trackHandle);
#endif
...
audio_unique_id_t AudioFlinger::nextUniqueId(audio_unique_id_use_t use)
{
    ...
    LOG_ALWAYS_FATAL_IF((unsigned) use >= (unsigned) AUDIO_UNIQUE_ID_USE_MAX, "_MSC_VER"); // M3E:
    ...
    for (int retry = 0; retry < maxRetries; retry++) {
        ...
        ALOG_ASSERT(audio_unique_id_get_use(base) == AUDIO_UNIQUE_ID_USE_UNSPECIFIED, "_MSC_VER"); // M3E:
