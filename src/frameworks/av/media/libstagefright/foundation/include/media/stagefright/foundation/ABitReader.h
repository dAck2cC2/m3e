...
class ANDROID_API_STAGEFRIGHT_FOUNDATION ABitReader { // M3E: MSVC export
public:
...
class ANDROID_API_STAGEFRIGHT_FOUNDATION NALBitReader : public ABitReader { // M3E: MSVC export
public:
