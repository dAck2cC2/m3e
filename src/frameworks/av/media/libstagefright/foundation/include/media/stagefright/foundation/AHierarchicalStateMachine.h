...
struct ANDROID_API_STAGEFRIGHT_FOUNDATION AState : public RefBase { // M3E: MSVC export
...
struct ANDROID_API_STAGEFRIGHT_FOUNDATION AHierarchicalStateMachine { // M3E: MSVC export
