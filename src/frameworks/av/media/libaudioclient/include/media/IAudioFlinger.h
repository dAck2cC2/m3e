...
class ANDROID_API_AUDIOCLIENT IAudioFlinger : public IInterface // M3E: MSVC export
{
public:
...
class ANDROID_API_AUDIOCLIENT BnAudioFlinger : public BnInterface<IAudioFlinger> // M3E: MSVC export
{
public:
