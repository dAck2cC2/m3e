...
class ANDROID_API_AUDIOCLIENT IAudioPolicyService : public IInterface
{
public:
...
class ANDROID_API_AUDIOCLIENT BnAudioPolicyService : public BnInterface<IAudioPolicyService>
{
public:
