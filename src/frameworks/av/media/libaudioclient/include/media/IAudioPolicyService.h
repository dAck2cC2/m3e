...
class ANDROID_API_AUDIOCLIENT IAudioPolicyService : public IInterface // M3E: MSVC export
{
public:
...
class ANDROID_API_AUDIOCLIENT BnAudioPolicyService : public BnInterface<IAudioPolicyService> // M3E: MSVC export
{
public:
