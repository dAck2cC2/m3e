...
class ANDROID_API_MEDIA IResourceManagerClient: public IInterface // M3E: MSVC export
{
public:
...
class ANDROID_API_MEDIA BnResourceManagerClient: public BnInterface<IResourceManagerClient> // M3E: MSVC export
{
public:
