 ...
 */
class ANDROID_API_GUI ISurfaceComposer: public IInterface { /* M3E: MSVC export */
public:
...
class ANDROID_API_GUI BnSurfaceComposer: public BnInterface<ISurfaceComposer> { /* M3E: MSVC export */
public:
    enum {
