 ...
 */
class ANDROID_API_GUI IGraphicBufferProducer : public IInterface /* M3E: MSVC export */
{
public:
...
class ANDROID_API_GUI BnGraphicBufferProducer : public BnInterface<IGraphicBufferProducer> /* M3E: MSVC export */
{
public:
