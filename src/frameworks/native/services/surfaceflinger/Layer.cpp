...
#include "customized/SurfaceHandler.h"
        ...
        mFreezeGeometryUpdates(false)
{
	...
	mEGLWindow = (EGLNativeWindowType)(flinger->getHwComposer().nativeWindowCreate(mName.c_str()));
}
...
#if 1
	return (new SurfaceHandle(mFlinger, this));
#else
...
* customized
**************************************************************************/
void Layer::updateEGLNativeWindow() 
{
	mFlinger->getHwComposer().nativeWindowMessageLoop(mEGLWindow);
}
