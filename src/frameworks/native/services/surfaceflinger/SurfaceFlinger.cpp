...
SurfaceFlinger::SurfaceFlinger(surfaceflinger::Factory& factory, SkipInitializationTag)
      : mFactory(factory),
...
SurfaceFlinger::SurfaceFlinger(surfaceflinger::Factory& factory) : SurfaceFlinger(factory, SkipInitialization) {
    ALOGI("SurfaceFlinger is starting");

#if 0 /* M3E: no ISurfaceFlingerConfigs */
...
bool SurfaceFlinger::performSetActiveConfig() {
    ...
    LOG_ALWAYS_FATAL_IF(!displayId, "M3E");
        ...
        for (const auto& pair : mDisplays) {
            ...
            if (displayState.isEnabled) {
                ...
                mDrawingState.traverseInZOrder([&](Layer* layer) {
                    ...
                    LOG_ALWAYS_FATAL_IF(layerFE.get() == nullptr, "M3E");
...
void SurfaceFlinger::onInitializeDisplays() {
    ...
    LOG_ALWAYS_FATAL_IF(token == nullptr, "M3E");
