...
public:
    ...
    static /* M3E: constexpr */ SkipInitializationTag SkipInitialization;
    SurfaceFlinger(surfaceflinger::Factory&, SkipInitializationTag) /* M3E: ANDROID_API */;
    explicit SurfaceFlinger(surfaceflinger::Factory&) /* M3E: ANDROID_API */;

    // must be called before clients can connect
    void init() /* M3E: ANDROID_API */;

    // starts SurfaceFlinger main loop in the current thread
    void run() /* M3E: ANDROID_API */;
...
public:   /* M3E: allow inheriting of NATIVE::SurfaceFlinger */
...
protected:   /* M3E: allow accessing from NATIVE::SurfaceFlinger & NATIVE::BufferProducer */
...
protected: /* M3E: for NATIVE::SurfaceFlinger */
