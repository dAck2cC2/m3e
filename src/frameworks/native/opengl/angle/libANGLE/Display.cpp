...
#elif defined(ANGLE_ENABLE_OPENGL) && defined(ANGLE_PLATFORM_WINDOWS)
...
#ifdef ANGLE_ENABLE_ANNOTATIONS
                             ...
                             gl::Context **outContext)
{
	...
	gl::MemoryProgramCache *cachePointer = nullptr;
	/*
	...
	cachePointer = &mMemoryProgramCache;
