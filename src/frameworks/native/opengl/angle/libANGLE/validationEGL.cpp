    ...
    for (AttributeMap::const_iterator attributeIter = attributes.begin(); attributeIter != attributes.end(); attributeIter++)
    {
        ...
        switch (attribute)
        {
          ...
          case EGL_CONTEXT_OPENGL_NO_ERROR_KHR:
              ...
              break;
#ifdef EGL_ANGLE_create_context_webgl_compatibility
          case EGL_CONTEXT_WEBGL_COMPATIBILITY_ANGLE:
              ...
              break;
#endif
#ifdef EGL_CHROMIUM_create_context_bind_generates_resource
...
#endif
              break;
#ifdef EGL_ANGLE_create_context_client_arrays
          case EGL_CONTEXT_CLIENT_ARRAYS_ENABLED_ANGLE:
              ...
              break;
#endif
#ifdef EGL_ANGLE_program_cache_control
    ...
    for (AttributeMap::const_iterator attributeIter = attributes.begin(); attributeIter != attributes.end(); attributeIter++)
    {
        ...
        switch (attribute)
        {
          ...
          case EGL_POST_SUB_BUFFER_SUPPORTED_NV:
            ...
            break;
#ifdef EGL_ANGLE_flexible_surface_compatibility
