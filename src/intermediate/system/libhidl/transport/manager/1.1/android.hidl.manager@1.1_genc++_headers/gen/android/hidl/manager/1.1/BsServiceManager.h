...
struct BsServiceManager : IServiceManager, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::sp<::android::hidl::base::V1_0::IBase>> get(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "get", &_hidl_args);
            }
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "get", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> add(const ::android::hardware::hidl_string& name, const ::android::sp<::android::hidl::base::V1_0::IBase>& service) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "add", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "add", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::hidl::manager::V1_0::IServiceManager::Transport> getTransport(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&name);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "getTransport", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "getTransport", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> list(list_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "list", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->list([&](const auto &_hidl_out_fqInstanceNames) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "list", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> listByInterface(const ::android::hardware::hidl_string& fqName, listByInterface_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&fqName);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "listByInterface", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->listByInterface(fqName, [&](const auto &_hidl_out_instanceNames) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "listByInterface", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> registerForNotifications(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name, const ::android::sp<::android::hidl::manager::V1_0::IServiceNotification>& callback) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "registerForNotifications", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "registerForNotifications", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> debugDump(debugDump_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "debugDump", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->debugDump([&](const auto &_hidl_out_info) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "debugDump", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> registerPassthroughClient(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&name);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "registerPassthroughClient", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "registerPassthroughClient", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> unregisterForNotifications(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name, const ::android::sp<::android::hidl::manager::V1_0::IServiceNotification>& callback) {
    ...
    ::android::hardware::Return<void> interfaceChain(interfaceChain_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "interfaceChain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->interfaceChain([&](const auto &_hidl_out_descriptors) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "interfaceChain", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> debug(const ::android::hardware::hidl_handle& fd, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& options) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "debug", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "debug", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> interfaceDescriptor(interfaceDescriptor_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "interfaceDescriptor", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->interfaceDescriptor([&](const auto &_hidl_out_descriptor) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "interfaceDescriptor", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getHashChain(getHashChain_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "getHashChain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getHashChain([&](const auto &_hidl_out_hashchain) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "getHashChain", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> linkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient, uint64_t cookie) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "linkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "linkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> ping() {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "ping", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "ping", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getDebugInfo(getDebugInfo_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "getDebugInfo", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getDebugInfo([&](const auto &_hidl_out_info) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                _hidl_args.push_back((void *)&_hidl_out_info);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "getDebugInfo", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> notifySyspropsChanged() {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "notifySyspropsChanged", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        , mEnableInstrumentation = this->mEnableInstrumentation, mInstrumentationCallbacks = this->mInstrumentationCallbacks
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "notifySyspropsChanged", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> unlinkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&recipient);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hidl.manager", "1.1", "IServiceManager", "unlinkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hidl.manager", "1.1", "IServiceManager", "unlinkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
