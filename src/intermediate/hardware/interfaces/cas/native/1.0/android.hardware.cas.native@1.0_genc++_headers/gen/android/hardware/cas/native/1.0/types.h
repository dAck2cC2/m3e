...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::cas::native::V1_0::ScramblingControl>
{
    const ::android::hardware::cas::native::V1_0::ScramblingControl* begin() { return static_begin(); }
    const ::android::hardware::cas::native::V1_0::ScramblingControl* end() { return begin() + 4; }
    private:
    static const ::android::hardware::cas::native::V1_0::ScramblingControl* static_begin() {
        static const ::android::hardware::cas::native::V1_0::ScramblingControl kVals[4] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::cas::native::V1_0::BufferType>
{
    const ::android::hardware::cas::native::V1_0::BufferType* begin() { return static_begin(); }
    const ::android::hardware::cas::native::V1_0::BufferType* end() { return begin() + 2; }
    private:
    static const ::android::hardware::cas::native::V1_0::BufferType* static_begin() {
        static const ::android::hardware::cas::native::V1_0::BufferType kVals[2] {
