...
struct BsMediaCasService : IMediaCasService, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_0::ICas>> createPlugin(int32_t CA_system_id, const ::android::sp<::android::hardware::cas::V1_0::ICasListener>& listener) {
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_0::IDescramblerBase>> createDescrambler(int32_t CA_system_id) {
