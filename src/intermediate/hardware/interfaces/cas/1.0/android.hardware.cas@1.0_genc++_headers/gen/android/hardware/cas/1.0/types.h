...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::cas::V1_0::Status>
{
    const ::android::hardware::cas::V1_0::Status* begin() { return static_begin(); }
    const ::android::hardware::cas::V1_0::Status* end() { return begin() + 15; }
    private:
    static const ::android::hardware::cas::V1_0::Status* static_begin() {
        static const ::android::hardware::cas::V1_0::Status kVals[15] {
