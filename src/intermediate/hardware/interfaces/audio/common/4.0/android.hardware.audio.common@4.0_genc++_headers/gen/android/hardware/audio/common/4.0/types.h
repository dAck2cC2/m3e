...
enum class AudioChannelMask : uint32_t {
    ...
    OUT_FRONT_RIGHT = 2u,
    OUT_FRONT_CENTER = 4u,
    OUT_LOW_FREQUENCY = 8u,
    OUT_BACK_LEFT = 16u,
    OUT_BACK_RIGHT = 32u,
    OUT_FRONT_LEFT_OF_CENTER = 64u,
    OUT_FRONT_RIGHT_OF_CENTER = 128u,
    OUT_BACK_CENTER = 256u,
    OUT_SIDE_LEFT = 512u,
    OUT_SIDE_RIGHT = 1024u,
    OUT_TOP_CENTER = 2048u,
    OUT_TOP_FRONT_LEFT = 4096u,
    OUT_TOP_FRONT_CENTER = 8192u,
    OUT_TOP_FRONT_RIGHT = 16384u,
    OUT_TOP_BACK_LEFT = 32768u,
    OUT_TOP_BACK_CENTER = 65536u,
    OUT_TOP_BACK_RIGHT = 131072u,
    OUT_TOP_SIDE_LEFT = 262144u,
    OUT_TOP_SIDE_RIGHT = 524288u,
    ...
    IN_FRONT = 16u,
    IN_BACK = 32u,
    IN_LEFT_PROCESSED = 64u,
    IN_RIGHT_PROCESSED = 128u,
    IN_FRONT_PROCESSED = 256u,
    IN_BACK_PROCESSED = 512u,
    IN_PRESSURE = 1024u,
    IN_X_AXIS = 2048u,
    IN_Y_AXIS = 4096u,
    IN_Z_AXIS = 8192u,
    IN_BACK_LEFT = 65536u,
    IN_BACK_RIGHT = 131072u,
    IN_CENTER = 262144u,
    IN_LOW_FREQUENCY = 1048576u,
    IN_TOP_LEFT = 2097152u,
    IN_TOP_RIGHT = 4194304u,
    IN_VOICE_UPLINK = 16384u,
    IN_VOICE_DNLINK = 32768u,
...
enum class AudioDevice : uint32_t {
     ...
     * reserved bits  */
    BIT_IN = 2147483648u,
    BIT_DEFAULT = 1073741824u,
    /**
     * output devices  */
    OUT_EARPIECE = 1u,
    OUT_SPEAKER = 2u,
    OUT_WIRED_HEADSET = 4u,
    OUT_WIRED_HEADPHONE = 8u,
    OUT_BLUETOOTH_SCO = 16u,
    OUT_BLUETOOTH_SCO_HEADSET = 32u,
    OUT_BLUETOOTH_SCO_CARKIT = 64u,
    OUT_BLUETOOTH_A2DP = 128u,
    OUT_BLUETOOTH_A2DP_HEADPHONES = 256u,
    OUT_BLUETOOTH_A2DP_SPEAKER = 512u,
    OUT_AUX_DIGITAL = 1024u,
    OUT_HDMI = 1024u, // OUT_AUX_DIGITAL
    /**
     * uses an analog connection (multiplexed over the USB pins for instance)  */
    OUT_ANLG_DOCK_HEADSET = 2048u,
    OUT_DGTL_DOCK_HEADSET = 4096u,
    /**
     * USB accessory mode: Android device is USB device and dock is USB host  */
    OUT_USB_ACCESSORY = 8192u,
    /**
     * USB host mode: Android device is USB host and dock is USB device  */
    OUT_USB_DEVICE = 16384u,
    OUT_REMOTE_SUBMIX = 32768u,
    /**
     * Telephony voice TX path  */
    OUT_TELEPHONY_TX = 65536u,
    /**
     * Analog jack with line impedance detected  */
    OUT_LINE = 131072u,
    /**
     * HDMI Audio Return Channel  */
    OUT_HDMI_ARC = 262144u,
    /**
     * S/PDIF out  */
    OUT_SPDIF = 524288u,
    /**
    ...
    OUT_AUX_LINE = 2097152u,
    /**
     * limited-output speaker device for acoustic safety  */
    OUT_SPEAKER_SAFE = 4194304u,
    OUT_IP = 8388608u,
    /**
     * audio bus implemented by the audio system (e.g an MOST stereo channel)  */
    OUT_BUS = 16777216u,
    OUT_PROXY = 33554432u,
    OUT_USB_HEADSET = 67108864u,
    OUT_HEARING_AID = 134217728u,
    OUT_ECHO_CANCELLER = 268435456u,
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioHandleConsts>
{
    const ::android::hardware::audio::common::V4_0::AudioHandleConsts* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioHandleConsts* end() { return begin() + 4; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioHandleConsts* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioHandleConsts kVals[4] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioStreamType>
{
    const ::android::hardware::audio::common::V4_0::AudioStreamType* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioStreamType* end() { return begin() + 13; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioStreamType* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioStreamType kVals[13] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioSource>
{
    const ::android::hardware::audio::common::V4_0::AudioSource* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioSource* end() { return begin() + 11; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioSource* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioSource kVals[11] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioSessionConsts>
{
    const ::android::hardware::audio::common::V4_0::AudioSessionConsts* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioSessionConsts* end() { return begin() + 4; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioSessionConsts* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioSessionConsts kVals[4] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioFormat>
{
    const ::android::hardware::audio::common::V4_0::AudioFormat* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioFormat* end() { return begin() + 96; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioFormat* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioFormat kVals[96] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::FixedChannelCount>
{
    const ::android::hardware::audio::common::V4_0::FixedChannelCount* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::FixedChannelCount* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::common::V4_0::FixedChannelCount* static_begin() {
        static const ::android::hardware::audio::common::V4_0::FixedChannelCount kVals[2] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioChannelMask>
{
    const ::android::hardware::audio::common::V4_0::AudioChannelMask* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioChannelMask* end() { return begin() + 87; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioChannelMask* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioChannelMask kVals[87] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioMode>
{
    const ::android::hardware::audio::common::V4_0::AudioMode* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioMode* end() { return begin() + 4; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioMode* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioMode kVals[4] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioDevice>
{
    const ::android::hardware::audio::common::V4_0::AudioDevice* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioDevice* end() { return begin() + 61; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioDevice* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioDevice kVals[61] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioOutputFlag>
{
    const ::android::hardware::audio::common::V4_0::AudioOutputFlag* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioOutputFlag* end() { return begin() + 16; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioOutputFlag* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioOutputFlag kVals[16] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioInputFlag>
{
    const ::android::hardware::audio::common::V4_0::AudioInputFlag* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioInputFlag* end() { return begin() + 8; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioInputFlag* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioInputFlag kVals[8] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioUsage>
{
    const ::android::hardware::audio::common::V4_0::AudioUsage* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioUsage* end() { return begin() + 13; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioUsage* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioUsage kVals[13] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioContentType>
{
    const ::android::hardware::audio::common::V4_0::AudioContentType* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioContentType* end() { return begin() + 5; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioContentType* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioContentType kVals[5] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioGainMode>
{
    const ::android::hardware::audio::common::V4_0::AudioGainMode* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioGainMode* end() { return begin() + 3; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioGainMode* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioGainMode kVals[3] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioPortRole>
{
    const ::android::hardware::audio::common::V4_0::AudioPortRole* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioPortRole* end() { return begin() + 3; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioPortRole* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioPortRole kVals[3] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioPortType>
{
    const ::android::hardware::audio::common::V4_0::AudioPortType* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioPortType* end() { return begin() + 4; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioPortType* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioPortType kVals[4] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioPortConfigMask>
{
    const ::android::hardware::audio::common::V4_0::AudioPortConfigMask* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioPortConfigMask* end() { return begin() + 4; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioPortConfigMask* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioPortConfigMask kVals[4] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::common::V4_0::AudioMixLatencyClass>
{
    const ::android::hardware::audio::common::V4_0::AudioMixLatencyClass* begin() { return static_begin(); }
    const ::android::hardware::audio::common::V4_0::AudioMixLatencyClass* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::common::V4_0::AudioMixLatencyClass* static_begin() {
        static const ::android::hardware::audio::common::V4_0::AudioMixLatencyClass kVals[2] {
