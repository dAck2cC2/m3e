...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::effect::V2_0::IVirtualizerEffect::StrengthRange>
{
    const ::android::hardware::audio::effect::V2_0::IVirtualizerEffect::StrengthRange* begin() { return static_begin(); }
    const ::android::hardware::audio::effect::V2_0::IVirtualizerEffect::StrengthRange* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::effect::V2_0::IVirtualizerEffect::StrengthRange* static_begin() {
        static const ::android::hardware::audio::effect::V2_0::IVirtualizerEffect::StrengthRange kVals[2] {
