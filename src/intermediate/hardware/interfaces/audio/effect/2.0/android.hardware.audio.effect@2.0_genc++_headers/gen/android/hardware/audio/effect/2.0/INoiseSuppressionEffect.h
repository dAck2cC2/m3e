...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Level>
{
    const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Level* begin() { return static_begin(); }
    const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Level* end() { return begin() + 3; }
    private:
    static const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Level* static_begin() {
        static const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Level kVals[3] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Type>
{
    const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Type* begin() { return static_begin(); }
    const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Type* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Type* static_begin() {
        static const ::android::hardware::audio::effect::V2_0::INoiseSuppressionEffect::Type kVals[2] {
