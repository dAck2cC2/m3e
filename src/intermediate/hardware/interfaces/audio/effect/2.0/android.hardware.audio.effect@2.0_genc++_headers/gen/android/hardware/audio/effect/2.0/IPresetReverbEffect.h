...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset>
{
    const ::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset* begin() { return static_begin(); }
    const ::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset* end() { return begin() + 8; }
    private:
    static const ::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset* static_begin() {
        static const ::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset kVals[8] {
