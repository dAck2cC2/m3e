...
::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> BpHwLoudnessEnhancerEffect::_hidl_setTargetGain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t targetGainMb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ILoudnessEnhancerEffect::setTargetGain::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(29 /* setTargetGain */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwLoudnessEnhancerEffect::_hidl_getTargetGain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getTargetGain_cb _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ILoudnessEnhancerEffect::getTargetGain::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getTargetGain */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::status_t BnHwLoudnessEnhancerEffect::_hidl_getTargetGain(
    ...
    static_cast<ILoudnessEnhancerEffect*>(_hidl_this->getImpl().get())->getTargetGain([&](const auto &_hidl_out_retval, const auto &_hidl_out_targetGainMb) {
...
::android::status_t ILoudnessEnhancerEffect::registerAsService(const std::string &serviceName) {
    ::android::hardware::details::onRegistration("android.hardware.audio.effect@2.0", "ILoudnessEnhancerEffect", serviceName);
