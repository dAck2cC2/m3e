...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::effect::V4_0::IDownmixEffect::Type>
{
    const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type* begin() { return static_begin(); }
    const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type* static_begin() {
        static const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type kVals[2] {
