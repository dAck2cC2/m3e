...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::effect::V4_0::IBassBoostEffect::StrengthRange>
{
    const ::android::hardware::audio::effect::V4_0::IBassBoostEffect::StrengthRange* begin() { return static_begin(); }
    const ::android::hardware::audio::effect::V4_0::IBassBoostEffect::StrengthRange* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::effect::V4_0::IBassBoostEffect::StrengthRange* static_begin() {
        static const ::android::hardware::audio::effect::V4_0::IBassBoostEffect::StrengthRange kVals[2] {
