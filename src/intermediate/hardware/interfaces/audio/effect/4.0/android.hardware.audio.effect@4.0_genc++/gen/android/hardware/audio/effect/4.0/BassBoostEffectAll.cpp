...
::android::hardware::Return<void> BpHwBassBoostEffect::_hidl_isStrengthSupported(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, isStrengthSupported_cb _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBassBoostEffect::isStrengthSupported::client");
    #ifdef __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwBassBoostEffect::_hidl_setStrength(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t strength) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBassBoostEffect::setStrength::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
...
::android::hardware::Return<void> BpHwBassBoostEffect::_hidl_getStrength(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getStrength_cb _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBassBoostEffect::getStrength::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
...
::android::status_t BnHwBassBoostEffect::_hidl_isStrengthSupported(
    ...
    static_cast<IBassBoostEffect*>(_hidl_this->getImpl().get())->isStrengthSupported([&](const auto &_hidl_out_retval, const auto &_hidl_out_strengthSupported) {
...
::android::status_t BnHwBassBoostEffect::_hidl_getStrength(
    ...
    static_cast<IBassBoostEffect*>(_hidl_this->getImpl().get())->getStrength([&](const auto &_hidl_out_retval, const auto &_hidl_out_strength) {
        if (_hidl_callbackCalled) {
...
::android::status_t IBassBoostEffect::registerAsService(const std::string &serviceName) {
    ::android::hardware::details::onRegistration("android.hardware.audio.effect@4.0", "IBassBoostEffect", serviceName);
