...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwAcousticEchoCancelerEffect::_hidl_setEchoDelay(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t echoDelayMs) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IAcousticEchoCancelerEffect::setEchoDelay::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(29 /* setEchoDelay */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwAcousticEchoCancelerEffect::_hidl_getEchoDelay(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getEchoDelay_cb _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IAcousticEchoCancelerEffect::getEchoDelay::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getEchoDelay */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::status_t BnHwAcousticEchoCancelerEffect::_hidl_getEchoDelay(
    ...
    static_cast<IAcousticEchoCancelerEffect*>(_hidl_this->getImpl().get())->getEchoDelay([&](const auto &_hidl_out_retval, const auto &_hidl_out_echoDelayMs) {
...
::android::status_t IAcousticEchoCancelerEffect::registerAsService(const std::string &serviceName) {
    ::android::hardware::details::onRegistration("android.hardware.audio.effect@4.0", "IAcousticEchoCancelerEffect", serviceName);
