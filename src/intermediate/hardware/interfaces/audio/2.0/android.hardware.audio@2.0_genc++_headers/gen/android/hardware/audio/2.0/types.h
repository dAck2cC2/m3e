...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::V2_0::Result>
{
    const ::android::hardware::audio::V2_0::Result* begin() { return static_begin(); }
    const ::android::hardware::audio::V2_0::Result* end() { return begin() + 5; }
    private:
    static const ::android::hardware::audio::V2_0::Result* static_begin() {
        static const ::android::hardware::audio::V2_0::Result kVals[5] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::V2_0::AudioDrain>
{
    const ::android::hardware::audio::V2_0::AudioDrain* begin() { return static_begin(); }
    const ::android::hardware::audio::V2_0::AudioDrain* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::V2_0::AudioDrain* static_begin() {
        static const ::android::hardware::audio::V2_0::AudioDrain kVals[2] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::V2_0::MessageQueueFlagBits>
{
    const ::android::hardware::audio::V2_0::MessageQueueFlagBits* begin() { return static_begin(); }
    const ::android::hardware::audio::V2_0::MessageQueueFlagBits* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::V2_0::MessageQueueFlagBits* static_begin() {
        static const ::android::hardware::audio::V2_0::MessageQueueFlagBits kVals[2] {
