...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::V4_0::IStreamIn::ReadCommand>
{
    const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand* begin() { return static_begin(); }
    const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand* end() { return begin() + 2; }
    private:
    static const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand* static_begin() {
        static const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand kVals[2] {
