...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::audio::V4_0::IStreamOut::WriteCommand>
{
    const ::android::hardware::audio::V4_0::IStreamOut::WriteCommand* begin() { return static_begin(); }
    const ::android::hardware::audio::V4_0::IStreamOut::WriteCommand* end() { return begin() + 3; }
    private:
    static const ::android::hardware::audio::V4_0::IStreamOut::WriteCommand* static_begin() {
        static const ::android::hardware::audio::V4_0::IStreamOut::WriteCommand kVals[3] {
