...
::android::hardware::Return<void> BpHwDevice::_hidl_getMicrophones(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getMicrophones_cb _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::getMicrophones::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(20 /* getMicrophones */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<::android::hardware::audio::V4_0::Result> BpHwDevice::_hidl_setConnectedState(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::V4_0::DeviceAddress& address, bool connected) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::setConnectedState::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(21 /* setConnectedState */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::status_t BnHwDevice::_hidl_openOutputStream(
    ...
    static_cast<IDevice*>(_hidl_this->getImpl().get())->openOutputStream(ioHandle, *device, *config, flags, *sourceMetadata, [&](const auto &_hidl_out_retval, const auto &_hidl_out_outStream, const auto &_hidl_out_suggestedConfig) {
        if (_hidl_callbackCalled) {
        ...
        if (_hidl_out_outStream == nullptr) {
            ...
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::toBinder<
                    ::android::hardware::audio::V4_0::IStreamOut>(_hidl_out_outStream);
...
::android::status_t BnHwDevice::_hidl_openInputStream(
    ...
    static_cast<IDevice*>(_hidl_this->getImpl().get())->openInputStream(ioHandle, *device, *config, flags, *sinkMetadata, [&](const auto &_hidl_out_retval, const auto &_hidl_out_inStream, const auto &_hidl_out_suggestedConfig) {
        if (_hidl_callbackCalled) {
        ...
        if (_hidl_out_inStream == nullptr) {
            ...
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::toBinder<
                    ::android::hardware::audio::V4_0::IStreamIn>(_hidl_out_inStream);
            if (_hidl_binder.get() != nullptr) {
                _hidl_err = _hidl_reply->writeStrongBinder(_hidl_binder);
            } else {
                _hidl_err = ::android::UNKNOWN_ERROR;
...
::android::status_t BnHwDevice::_hidl_getHwAvSync(
    ...
    static_cast<IDevice*>(_hidl_this->getImpl().get())->getHwAvSync([&](const auto &_hidl_out_retval, const auto &_hidl_out_hwAvSync) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwDevice::_hidl_getParameters(
    ...
    static_cast<IDevice*>(_hidl_this->getImpl().get())->getParameters(*context, *keys, [&](const auto &_hidl_out_retval, const auto &_hidl_out_parameters) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwDevice::_hidl_getMicrophones(
    ...
    static_cast<IDevice*>(_hidl_this->getImpl().get())->getMicrophones([&](const auto &_hidl_out_retval, const auto &_hidl_out_microphones) {
        if (_hidl_callbackCalled) {
...
::android::status_t IDevice::registerAsService(const std::string &serviceName) {
    ::android::hardware::details::onRegistration("android.hardware.audio@4.0", "IDevice", serviceName);
