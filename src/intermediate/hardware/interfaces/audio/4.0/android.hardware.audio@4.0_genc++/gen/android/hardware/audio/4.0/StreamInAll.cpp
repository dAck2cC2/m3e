...
::android::hardware::Return<void> BpHwStreamIn::_hidl_getAudioSource(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getAudioSource_cb _hidl_cb) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(27 /* getAudioSource */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<::android::hardware::audio::V4_0::Result> BpHwStreamIn::_hidl_setGain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float gain) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(28 /* setGain */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_updateSinkMetadata(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::V4_0::SinkMetadata& sinkMetadata) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IStreamIn::updateSinkMetadata::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(29 /* updateSinkMetadata */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_prepareForReading(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t frameSize, uint32_t framesCount, prepareForReading_cb _hidl_cb) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* prepareForReading */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<uint32_t> BpHwStreamIn::_hidl_getInputFramesLost(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(31 /* getInputFramesLost */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_getCapturePosition(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getCapturePosition_cb _hidl_cb) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(32 /* getCapturePosition */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_getActiveMicrophones(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getActiveMicrophones_cb _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IStreamIn::getActiveMicrophones::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(33 /* getActiveMicrophones */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
...
::android::status_t BnHwStreamIn::_hidl_updateSinkMetadata(
    ...
    static_cast<IStreamIn*>(_hidl_this->getImpl().get())->updateSinkMetadata(*sinkMetadata);
...
::android::status_t BnHwStreamIn::_hidl_getActiveMicrophones(
    ...
    static_cast<IStreamIn*>(_hidl_this->getImpl().get())->getActiveMicrophones([&](const auto &_hidl_out_retval, const auto &_hidl_out_microphones) {
        if (_hidl_callbackCalled) {
...
::android::status_t IStreamIn::registerAsService(const std::string &serviceName) {
    ::android::hardware::details::onRegistration("android.hardware.audio@4.0", "IStreamIn", serviceName);
