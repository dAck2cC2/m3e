...
struct BsOmx : IOmx, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> allocateNode(const ::android::hardware::hidl_string& name, const ::android::sp<::android::hardware::media::omx::V1_0::IOmxObserver>& observer, allocateNode_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
        ...
        auto _hidl_return = mImpl->allocateNode(name, _hidl_wrapped_observer, [&](const auto &_hidl_out_status, const auto &_hidl_out_omxNode) {
            ...
            ::android::sp<::android::hardware::media::omx::V1_0::IOmxNode> _hidl_out_wrapped_omxNode;
            if (_hidl_out_omxNode != nullptr && !_hidl_out_omxNode->isRemote()) {
                _hidl_out_wrapped_omxNode = ::android::hardware::details::wrapPassthrough(_hidl_out_omxNode);
    ...
    ::android::hardware::Return<void> createInputSurface(createInputSurface_cb _hidl_cb) {
        ...
        auto _hidl_return = mImpl->createInputSurface([&](const auto &_hidl_out_status, const auto &_hidl_out_producer, const auto &_hidl_out_source) {
            ...
            if (_hidl_out_producer != nullptr && !_hidl_out_producer->isRemote()) {
                _hidl_out_wrapped_producer = ::android::hardware::details::wrapPassthrough(_hidl_out_producer);
            ...
            ::android::sp<::android::hardware::media::omx::V1_0::IGraphicBufferSource> _hidl_out_wrapped_source;
            if (_hidl_out_source != nullptr && !_hidl_out_source->isRemote()) {
                _hidl_out_wrapped_source = ::android::hardware::details::wrapPassthrough(_hidl_out_source);
