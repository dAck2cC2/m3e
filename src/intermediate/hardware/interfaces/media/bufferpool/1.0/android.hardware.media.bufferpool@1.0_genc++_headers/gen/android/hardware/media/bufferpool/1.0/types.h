...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::media::bufferpool::V1_0::ResultStatus>
{
    const ::android::hardware::media::bufferpool::V1_0::ResultStatus* begin() { return static_begin(); }
    const ::android::hardware::media::bufferpool::V1_0::ResultStatus* end() { return begin() + 5; }
    private:
    static const ::android::hardware::media::bufferpool::V1_0::ResultStatus* static_begin() {
        static const ::android::hardware::media::bufferpool::V1_0::ResultStatus kVals[5] {
...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::media::bufferpool::V1_0::BufferStatus>
{
    const ::android::hardware::media::bufferpool::V1_0::BufferStatus* begin() { return static_begin(); }
    const ::android::hardware::media::bufferpool::V1_0::BufferStatus* end() { return begin() + 9; }
    private:
    static const ::android::hardware::media::bufferpool::V1_0::BufferStatus* static_begin() {
        static const ::android::hardware::media::bufferpool::V1_0::BufferStatus kVals[9] {
