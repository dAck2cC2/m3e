...
::android::status_t BnHwComposer::_hidl_getCapabilities(
    ...
    static_cast<IComposer*>(_hidl_this->getImpl().get())->getCapabilities([&](const auto &_hidl_out_capabilities) {
...
::android::status_t BnHwComposer::_hidl_dumpDebugInfo(
    ...
    static_cast<IComposer*>(_hidl_this->getImpl().get())->dumpDebugInfo([&](const auto &_hidl_out_debugInfo) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwComposer::_hidl_createClient(
    ...
    static_cast<IComposer*>(_hidl_this->getImpl().get())->createClient([&](const auto &_hidl_out_error, const auto &_hidl_out_client) {
        if (_hidl_callbackCalled) {
        ...
        if (_hidl_out_client == nullptr) {
            ...
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::toBinder<
                    ::android::hardware::graphics::composer::V2_1::IComposerClient>(_hidl_out_client);
