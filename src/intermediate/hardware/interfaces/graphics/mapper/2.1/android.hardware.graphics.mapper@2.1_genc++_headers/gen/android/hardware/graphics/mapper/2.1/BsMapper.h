...
struct BsMapper : IMapper, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> createDescriptor(const ::android::hardware::graphics::mapper::V2_0::IMapper::BufferDescriptorInfo& descriptorInfo, createDescriptor_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "createDescriptor", &_hidl_args);
            }
        }
        ...
        auto _hidl_return = mImpl->createDescriptor(descriptorInfo, [&](const auto &_hidl_out_error, const auto &_hidl_out_descriptor) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "createDescriptor", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> importBuffer(const ::android::hardware::hidl_handle& rawHandle, importBuffer_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "importBuffer", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->importBuffer(rawHandle, [&](const auto &_hidl_out_error, const auto &_hidl_out_buffer) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "importBuffer", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::hardware::graphics::mapper::V2_0::Error> freeBuffer(void* buffer) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "freeBuffer", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_error);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "freeBuffer", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> lock(void* buffer, ::android::hardware::hidl_bitfield<::android::hardware::graphics::common::V1_0::BufferUsage> cpuUsage, const ::android::hardware::graphics::mapper::V2_0::IMapper::Rect& accessRegion, const ::android::hardware::hidl_handle& acquireFence, lock_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "lock", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->lock(buffer, cpuUsage, accessRegion, acquireFence, [&](const auto &_hidl_out_error, const auto &_hidl_out_data) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "lock", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> lockYCbCr(void* buffer, ::android::hardware::hidl_bitfield<::android::hardware::graphics::common::V1_0::BufferUsage> cpuUsage, const ::android::hardware::graphics::mapper::V2_0::IMapper::Rect& accessRegion, const ::android::hardware::hidl_handle& acquireFence, lockYCbCr_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&acquireFence);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "lockYCbCr", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->lockYCbCr(buffer, cpuUsage, accessRegion, acquireFence, [&](const auto &_hidl_out_error, const auto &_hidl_out_layout) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "lockYCbCr", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> unlock(void* buffer, unlock_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&buffer);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "unlock", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->unlock(buffer, [&](const auto &_hidl_out_error, const auto &_hidl_out_releaseFence) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "unlock", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::hardware::graphics::mapper::V2_0::Error> validateBufferSize(void* buffer, const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& descriptorInfo, uint32_t stride) {
    ...
    ::android::hardware::Return<void> getTransportSize(void* buffer, getTransportSize_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
    ...
    ::android::hardware::Return<void> createDescriptor_2_1(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& descriptorInfo, createDescriptor_2_1_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
    ...
    ::android::hardware::Return<void> interfaceChain(interfaceChain_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "interfaceChain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->interfaceChain([&](const auto &_hidl_out_descriptors) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "interfaceChain", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> debug(const ::android::hardware::hidl_handle& fd, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& options) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "debug", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "debug", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> interfaceDescriptor(interfaceDescriptor_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "interfaceDescriptor", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->interfaceDescriptor([&](const auto &_hidl_out_descriptor) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                _hidl_args.push_back((void *)&_hidl_out_descriptor);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "interfaceDescriptor", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getHashChain(getHashChain_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "getHashChain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getHashChain([&](const auto &_hidl_out_hashchain) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "getHashChain", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> linkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient, uint64_t cookie) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "linkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "linkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> ping() {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "ping", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "ping", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getDebugInfo(getDebugInfo_cb _hidl_cb) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "getDebugInfo", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getDebugInfo([&](const auto &_hidl_out_info) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "getDebugInfo", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> notifySyspropsChanged() {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "notifySyspropsChanged", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        , mEnableInstrumentation = this->mEnableInstrumentation, mInstrumentationCallbacks = this->mInstrumentationCallbacks
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "notifySyspropsChanged", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> unlinkToDeath(const ::android::sp<::android::hardware::hidl_death_recipient>& recipient) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&recipient);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.mapper", "2.1", "IMapper", "unlinkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.mapper", "2.1", "IMapper", "unlinkToDeath", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
