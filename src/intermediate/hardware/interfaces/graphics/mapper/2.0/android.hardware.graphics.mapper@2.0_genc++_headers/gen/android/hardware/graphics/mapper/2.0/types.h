...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::graphics::mapper::V2_0::Error>
{
    const ::android::hardware::graphics::mapper::V2_0::Error* begin() { return static_begin(); }
    const ::android::hardware::graphics::mapper::V2_0::Error* end() { return begin() + 6; }
    private:
    static const ::android::hardware::graphics::mapper::V2_0::Error* static_begin() {
        static const ::android::hardware::graphics::mapper::V2_0::Error kVals[6] {
