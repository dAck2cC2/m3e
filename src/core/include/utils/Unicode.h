 ...
 */
ANDROID_API ssize_t utf8_to_utf16_length(const uint8_t* src, size_t srcLen, bool overreadIsFatal = false);
 ...
 */
ANDROID_API char16_t* utf8_to_utf16_no_null_terminator(
 ...
 */
ANDROID_API char16_t *utf8_to_utf16(
        const uint8_t* src, size_t srcLen, char16_t* dst, size_t dstLen);
